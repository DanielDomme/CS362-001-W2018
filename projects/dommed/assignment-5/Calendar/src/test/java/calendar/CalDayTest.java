...
public class CalDayTest {
	 ...
	 @Test
	  public void test05()  throws Throwable  {
		...
		Iterator<?> temp = calday2.iterator();
		LinkedList<Appt> temp2 = calday2.getAppts(); 
		Appt temp3 = (Appt)temp.next();
		
		assertEquals(20, temp3.getStartHour());
	 }
	 @Test
	  public void test06()  throws Throwable  {
		...
		assertEquals(14, temp3.getStartDay());
	 }
	 //needs work
	 @Test
	  ...
	  GregorianCalendar today = new GregorianCalendar();
		...
		assertEquals(temp, calday1.getAppts());
	 ...
	 @Test
	  ...
	  GregorianCalendar today = new GregorianCalendar();
		...
		String theDay = calday1.toString();
		assertNotNull(theDay);
